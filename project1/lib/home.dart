...
class Shruthihome extends StatefulWidget {
  const Shruthihome({Key? key}) : super(key: key);
 @override
  State<Shruthihome> createState() => _ShruthihomeState();
}
class _ShruthihomeState extends State<Shruthihome> {
  int index = 0;
void _quotes() {
    setState(() {
      index++;
